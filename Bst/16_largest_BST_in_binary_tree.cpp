// Source: https://www.geeksforgeeks.org/find-the-largest-subtree-in-a-tree-that-is-also-a-bst/
...
{ 
  ...
  *min_ref =  INT_MAX; 
  ...
  // Update min and max values for the parent recursive calls 
   ...
   cout<<"before::   "<<node->data<<"    min:  "<<min<<"    *min_ref:"<<*min_ref<<"    *max_ref:"<<*max_ref<<endl;
  if (min < *min_ref) 
     *min_ref = min; 
  ...
  if (node->data > *max_ref) 
     *max_ref = node->data; 
  cout<<"after::     "<<node->data<<"    min:  "<<min<<"    *min_ref:"<<*min_ref<<"    *max_ref:"<<*max_ref<<endl;
